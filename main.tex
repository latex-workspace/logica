...
\definizione{Rappresentazione mentale}{
...
\definizione{Polisemia (polysemy)}{
...
\definizione{Sinonimia (synonymity)}{
...
\definizione{Linguaggio asserzionistico}{
...
\definizione{Correttezza e completezza linguaggio}{
...
\definizione{Funzione di interpretazione di un linguaggio}{
Una funzione di interpretazione è una funzione:
\[
	\mathcal{I}_{A} : \mathcal{T}_{\mathcal{A}} \rightarrow M
\]
...
\definizione{Dominio, rappresentazione intensionale }{
...
\definizione{Fatto, rappresentazione intensionale}{
...
} \label{Fatto intensionale}
\definizione{Data domain, knowledge domain, mixed domain}{
...
\definizione{Linguaggio, rappresentazione intensionale}{
...
\definizione{Asserzione, rappresentazione intensionale}{
...
\definizione{Data language, knowledge language, mixed language}{
...
\definizione{Funzione di interpretazione, interpretazione intensionale}{
...
\definizione{Data/knowledge/mixed interpretation function}{
...
\definizione{Modello di mondo, interpretazione intensionale}{
...
\definizione{Linguaggi formali semi formali e informali}{
	\begin{enumerate}
...
\begin{center}
	\begin{tikzpicture}
		...
		\node [anchor=south]at (0,1) {Islamici};
		\node [anchor=south]at (0,3) {Terroristi};
		\draw [-latex, bend left](-3, 0)node[fill = white]{io}to(0,2);
		\node (ahmed)at (3,0) {Ahmed};
		\draw [-latex](ahmed)--(0,0);
	\end{tikzpicture}
\end{center}
\textit{Non è vero che tutti i terroristi sono islamici, ma è vero che tutti gli islamici sono terroristi}
